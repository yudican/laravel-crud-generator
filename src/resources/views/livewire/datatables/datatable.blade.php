    ...
    <div class="overflow-x-auto shadow-md sm:rounded-lg">
      <div class="flex justify-between items-center">
        ...
        <div class="pb-2 bg-white px-2 pt-2">
          <label for="table-search" class="sr-only">Search 2</label>
          <div class="relative mt-1">
            ...
            <input type="text" id="table-search" class="block pl-10 w-80 text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " wire:model.debounce.500ms="search" placeholder="Cari Disini qwqwq">
          </div>
        </div>
        {{-- end search --}}
        @endif
